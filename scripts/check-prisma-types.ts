...
function testUsageStatsTypes() {
  console.log('🔍 检查Prisma Client生成的UsageStats类型...')
  ...
  console.log('✅ modelId类型检查通过，字段为非空字符串类型')
  console.log('📊 当前modelId类型:', typeof typeCheck)
...
async function testRuntimeBehavior() {
  try {
    ...
    console.log(`✅ 创建成功，默认modelId: "${testUsage.modelId}"`)
